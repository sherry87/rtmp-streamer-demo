...
public class RtmpStreamer extends MovieClip {
    ...
    public function RtmpStreamer() {
		...
		ExternalInterface.addCallback("audio", audio);
	...
	public function audio(param1:String, param2:String) : void
        {
            var url:* = param1;
            var name:* = param2;
            this.connect(url, name, function (param1:String) : void
            {
                publishAudio(param1);
                return;
            }// end function
	...
	private function publishAudio(param1:String) : void
        {
...
//        H.264 Setting
		...
		ExternalInterface.call("console.log", "videoStreamSettings h264");
